...
\begin{align}
\log(\psi_{j,\ell}) &\sim \mcN(\mu_{j,\ell},\tau_{j,\ell}^2),&\ \ell&= 0,75, \nonumber\\
\log(\sigma_{j,\ell}) &\sim \mcN(m_{j,\ell}, s_{j,\ell}^2),&\ \ell&=0,75, \nonumber\\
\Delta\log(\psi_{j,\ell})&\sim \mcN(0, \sigma^2_{j,0}),&\ \ell,&=0,\dots,51, \nonumber\\
\Delta\log(\psi_{j,\ell})&\sim \mcN(0, \sigma^2_{j,75}),&\ \ell,&=75,\dots,111, \nonumber\\
\log(\psi_{j,\ell}) &= \log(\psi_{j,0}) + \sum_{k=0}^{\ell-1}\Delta\log(\psi_{j,k}),&\ \ell &= 1,\dots,52, \nonumber\\
\log(\psi_{j,\ell}) &= \log(\psi_{j,75}) + \sum_{k=0}^{\ell-1}\Delta\log(\psi_{j,75+k}),&\ \ell &= 76,\dots,112. \nonumber \\
...
\log(\sigma_{j,\ell}) &= m_{j,\ell} + s_{j,\ell}Z_{\log(\sigma_{j,\ell})},&\ \ell &= 0,75,\nonumber\\
