...
\begin{table}[!ht]
	...
	\caption[Week zero, and true and effective population sizes for a simulated Ebola outbreak in West Africa.]{True and effective population sizes, and initial conditions for a simulated outbreak in Guinea, Liberia, and Sierra Leone. Week zero is one week before the first observation is accrued and the time at which within--country transmission was assumed to begin. }\footnotesize
	\centering
	\begin{tabular}{lccc}		
...
\begin{sidewaystable}[!ht]
	...
	\begin{tabular}{lclll}
		...
		$ R_{eff,L} $ & 2.75 & Effective reproduction \# & $ R_{eff,L}\sim $ LogNormal(log(0.5), 1) & $ \implies R_{eff,L}^{(2)} = 1.50 (1.06, 5.32)$ \\
		...
		$ \omega_L $ & 0.7 & Rate from $ E_L\rightarrow I_L $ & $ (1/\mu_L)\big/(1/\omega_L) \sim $ LogNormal(0, 0.5$ ^2 $) & $ (1/\mu_L)\big/(1/\omega_L) $ = 1.00 (0.38, 2.66) \\
