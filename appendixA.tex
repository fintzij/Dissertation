...
\begin{table}[htbp]
	...
	\begin{tabular}{lrr}
		...
		\hline
		$ R_{eff,G}^{(1)} $& 1.19 (1.09, 1.37) & 1.13 (1.02, 1.39) \\ 
		$ R_{eff,G}^{(2)} $& 1.41 (1.18, 1.77) & 1.24 (1.02, 1.89) \\ 
		$ 7/\omega_G $& 8.42 (4.04, 17.25) & 5.56 (2.25, 18.25) \\ 
		$ 7/\mu_G $& 8.96 (5.9, 13.35) & 6.43 (3.12, 16.01) \\ 
		$ 1000\alpha_{G} $& 0.18 (0.01, 0.6) & 0.09 (0, 0.66) \\ 
		$ \rho_GN_{eff,G} $& 7250 (5140, 11930) & 9800 (4920, 34550) \\ 
		$ \phi_{G} $& 4.61 (2.81, 9.43) & 5.84 (3.02, 17.64) \\ 
		\hline
		$ R_{eff,L} $& 2.22 (1.67, 3.31) & 2.65 (1.58, 4.35) \\ 
		$ 7/\omega_L $& 10.51 (4.82, 19.57) & 13.68 (4.57, 23.12) \\ 
		$ 7/\mu_L $& 9.75 (6.63, 14.07) & 11.68 (5.72, 20.28) \\ 
		$ 1000\alpha_L $& 0.02 (0, 0.06) & 0.02 (0, 0.06) \\ 
		$ \rho_LN_{eff,L} $& 5650 (4650, 7372) & 5330 (4430, 7800) \\ 
		$ \phi_L $& 8.07 (3.74, 17.75) & 8.62 (3.96, 19.17) \\ 
		\hline
		$ R_{eff,S} $& 1.34 (1.22, 1.5) & 1.24 (1.13, 1.39) \\ 
		$ 7/\omega_S $& 4.47 (2.59, 7.4) & 3.46 (1.86, 5.96) \\ 
		$ 7/\mu_S $& 6.21 (4.52, 8.48) & 4.3 (2.61, 6.73) \\ 
		$ 1000\alpha_S $& 0.03 (0, 0.12) & 0.02 (0, 0.08) \\ 
		$ \rho_SN_{eff,S} $& 24270 (19110, 32770) & 30720 (21990, 48660) \\ 
		$ \phi_S $& 46.36 (21.94, 112.1) & 55.03 (25.6, 149.79) \\ 
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[htbp]
	...
	\begin{tabular}{crr}
		...
		\textbf{Parameter} & \textit{Tight Priors} & \textit{Loose Priors} \\ 
		\hline
		$ R_{eff,G}^{(1)} $& 1.14 (1.05, 1.3) & 1.07 (1.01, 1.23) \\ 
		$ R_{eff,G}^{(2)} $& 1.18 (1.06, 1.43) & 1.07 (1.01, 1.29) \\ 
		$ R_{eff,L} $& 2.06 (1.58, 3.34) & 1.85 (1.32, 3.41) \\ 
		$ R_{eff,S} $& 1.27 (1.14, 1.43) & 1.14 (1.02, 1.31) \\ 
		$ 7/\omega_G $& 7.55 (3.9, 13.6) & 5.55 (2.63, 11.42) \\ 
		$ 7/\omega_L $& 8.96 (4.05, 19.87) & 7.17 (2.46, 19.31) \\ 
		$ 7/\omega_S $& 4.14 (2.42, 6.58) & 2.98 (1.51, 5.37) \\ 
		$ 7/\mu_G $& 8.39 (5.94, 11.8) & 6.42 (3.59, 10.82) \\ 
		$ 7/\mu_L $& 8.99 (6.05, 13.22) & 7.53 (3.37, 15.54) \\ 
		$ 7/\mu_S $& 6.05 (4.4, 8.17) & 3.88 (2.36, 6.21) \\ 
		$ 1000\alpha_GL $& 3.01 (0.15, 15.48) & 6.25 (0.34, 29.79) \\ 
		$ 1000\alpha_GS $& 2.58 (0.11, 13.47) & 4.43 (0.15, 23.49) \\ 
		$ 1000\alpha_LG $& 3.87 (0.45, 14.18) & 6.47 (0.97, 20.53) \\ 
		$ 1000\alpha_LS $& 1.4 (0.06, 7.23) & 2.97 (0.22, 13.25) \\ 
		$ 1000\alpha_SG $& 2.55 (0.11, 13.38) & 4.68 (0.28, 24.99) \\ 
		$ 1000\alpha_SL $& 3.03 (0.1, 16.7) & 6.77 (0.18, 37.83) \\ 
		$ \rho_GN_{eff,G} $& 9910 (6630, 15600) & 14590 (7800, 29170) \\ 
		$ \rho_{L}N_{eff,L} $& 5920 (4770, 7940) & 6430 (4760, 11120) \\ 
		$ \rho_SN_{eff,S} $& 26800 (20630, 38700) & 39420 (24820, 85850) \\ 
		$ \phi_G $& 5.75 (3.36, 10.55) & 6.27 (3.57, 12.89) \\ 
		$ \phi_L $& 8.78 (4.09, 19.32) & 10.22 (4.74, 27.24) \\ 
		$ \phi_S $& 47.98 (21.57, 118.37) & 56.36 (25.33, 139.74) \\ 
		\hline
	\end{tabular}
\end{table}
