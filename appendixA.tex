...
\begin{table}[htbp]
	\caption[Posterior parameter estimates for a stratified SEIR model fit to a simulated Ebola outbreak.]{Posterior medians (95\% Bayesian credible intervals) for parameters of a stratified SEIR model fit to a simulated Ebola outbreak. Subscripts, $ G,L,S, $ indicate specific countries, or generic countries $ A,B $ if a prior is shared. Effective reproduction numbers are defined with respect to the effective population size as $ R_{eff} = \beta N_{eff} /\mu $. Parameter interpretations and priors are given in Table \ref{tab:ebola_synth_pars}.}
	\label{tab:ebola_synth_credints}
	\centering
	\begin{tabular}{ccc}
		\hline
		Parameter & Truth & Posterior median (95\% BCI) \\ 
		\hline
		$ R_{eff,G}^{(1)} $& 1.30 & 1.24 (1.12, 1.44) \\ 
		$ R_{eff,G}^{(2)} $& 1.10 & 1.28 (1.1, 1.63) \\ 
		$ R_{eff,L} $& 2.00 & 1.69 (1.37, 2.22) \\ 
		$ R_{eff,S} $& 1.55 & 1.54 (1.31, 1.97) \\ 
		$ 7/\omega_G $& 6.36 & 5.55 (2.92, 10.44) \\ 
		$ 7/\omega_L $& 8.24 & 6 (2.78, 11.2) \\ 
		$ 7/\omega_S $& 7.00 & 6.14 (3.26, 11.22) \\ 
		$ 7/\mu_G $& 7.00 & 6.19 (4.06, 9.65) \\ 
		$ 7/\mu_L $& 8.75 & 6.41 (4.05, 9.95) \\ 
		$ 7/\mu_S $& 6.36 & 6.46 (4.17, 10.04) \\ 
		$ 1000\alpha_{GL} $& 3.00 & 3.46 (0.13, 17.22) \\ 
		$ 1000\alpha_{GS} $& 3.00 & 3.75 (0.14, 18.93) \\ 
		$ 1000\alpha_{LG} $& 3.00 & 2.19 (0.12, 8.33) \\ 
		$ 1000\alpha_{LS} $& 3.00 & 3.03 (0.22, 11.3) \\ 
		$ 1000\alpha_{SG} $& 3.00 & 2.96 (0.16, 13.67) \\ 
		$ 1000\alpha_{SL} $& 3.00 & 2.69 (0.12, 11.51) \\ 
		$ \rho_GN_{eff,G} $& 12750 & 11570 (7750, 19320) \\ 
		$ \rho_LN_{eff,L} $& 8750 & 10030 (8070, 14180) \\ 
		$ \rho_SN_{eff,S} $& 15000 & 14860 (11510, 20580) \\ 
		$ \phi_{G} $& 50.00 & 59.78 (27.36, 211.88) \\ 
		$ \phi_{L} $& 50.00 & 46.61 (20.82, 105.31) \\ 
		$ \phi_{S} $& 50.00 & 33.13 (17.76, 60.48) \\
		\hline
	\end{tabular}
\end{table}

\begin{table}[htbp]
	\caption{Effective sample sizes and potential scale reduction factors for a stratified SEIR model fit to a simulated Ebola outbreak.}
	\centering
	\begin{tabular}{lrr}
		\hline
...
\begin{table}[ht]
	\caption[Posterior estimates of initial numbers of exposed, infected, and recovered individuals for a stratified SEIR model fit to simulated Ebola data.]{Posterior estimates of initial numbers of exposed, infected, and recovered individuals for a stratified SEIR model fit to simulated Ebola data. The effective number of susceptible individuals in each country corresponds to the effective population size minus the number of individuals in other disease states, but is not identifiable and therefore is not reported.}
	\centering
	\begin{tabular}{lrl}
		\hline
...
\label{subsec:ebola_joint_model_supplement}

\subsubsection{Priors and MCMC details}
\label{subsec:ebola_priors_mcmc}
...
\label{subsec:ebola_prior_sensitivity}

\begin{sidewaystable}[htbp]
	\begin{fullpage}
		\caption[Sensitivity analysis using more informative priors for a stratified SEIR model for Ebola in West Africa.]{Sensitivity analysis for a country--stratified SEIR model fit to the West Africa Ebola outbreak using more informative priors, vis--a--vis the main model, for the outbreak dynamics. In particular, the prior for the infectious period duration was tightened, and the prior for the ratio of infectious to latent period duration reflected a higher likelihood that the latent period might be shorter due to transmission from individuals with dry symptoms based on estimates in \cite{velasquez2015time,glynn2017variability}.  Subscripts, $ G,L,S, $ indicate specific countries, or generic countries $ A,B $ if a prior is shared. Effective reproduction numbers are defined with respect to the effective population size as $ R_{eff} = \beta N_{eff} /\mu $.}
		\label{tab:ebola_priors_informative}
		\scriptsize
		\centering
		\begin{tabular}{lllrr}
			\hline
			...
			\makecell[l]{$ \alpha_{GS},\alpha_{GL}, \alpha_{LG},$\\
				$ \alpha_{LS},\alpha_{SG}, \alpha_{SL} $} & \makecell[l]{Infectious migration rate \\ from country A to B} & $ 1000\alpha_{AB} \sim$ Exponential(0.25) & \makecell[r]{\# migrations per 1000 infected \\ = 2.78 (0.10, 14.76)} & \cite{dudas2017virus}\\ 
			$ \omega_G/\omega_G $ & Rate from $ E_G\rightarrow I_G $ & LogNormal(0.4, 0.3$ ^2 $) & $ (1/\mu_G)\big/(1/\omega_G) $ = 1.49 (0.83, 2.69) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ \omega_L/\omega_L $ & Rate from $ E_L\rightarrow I_L $ & LogNormal(0.4, 0.3$ ^2 $) & $ (1/\mu_L)\big/(1/\omega_L) $ = 1.49 (0.83, 2.69) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ \omega_S/\omega_S $ & Rate from $ E_S\rightarrow I_S $ & LogNormal(0.4, 0.3$ ^2 $) & $ (1/\mu_S)\big/(1/\omega_S) $ = 1.49 (0.83, 2.69) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ 1/\mu_G $ & Rate from $ E_G\rightarrow I_G $ &  LogNormal(0.3, 0.15$ ^2 $) & $ 7/\mu_G = $ 9.45 (7.04, 12.68) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ 1/\mu_L $ & Rate from $ E_L\rightarrow I_L $ &  LogNormal(0.3, 0.15$ ^2 $) & $ 7/\mu_L = $ 9.45 (7.04, 12.68) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ 1/\mu_S $ & Rate from $ E_S\rightarrow I_S $ &  LogNormal(0.3, 0.15$ ^2 $) & $ 7/\mu_S = $ 9.45 (7.04, 12.68) & \cite{chowell2014transmission,velasquez2015time,glynn2017variability} \\
			$ N_{eff,G} $ & Effective population size & $\mr{Unif}(\sum_{\ell=1}^{L}Y_\ell^G, N_G/4) $& $ N_{eff,G} \in (3627,\ 2.95\times10^6) $ & Scale of counts \\
			$ N_{eff,L} $ & Effective population size & $\mr{Unif}(\sum_{\ell=1}^{L}Y_\ell^L, N_L/4) $& $ N_{eff,L} \in (4994,\ 1.1\times10^6) $ & Scale of counts \\
			$ N_{eff,S} $ & Effective population size & $\mr{Unif}(\sum_{\ell=1}^{L}Y_\ell^S, N_S/4) $& $ N_{eff,S} \in (11317,\ 1.775\times10^6) $ & Scale of counts \\
			$ \rho_G $ &  Mean case detection prob. & LogitNormal(0, 1.4$ ^2 $) & $ \implies \rho_G = 0.5, (0.06, 0.94)$ & Very high and very low $ \rho $ unlikely. \\
...
\begin{sidewaystable}[htbp]
	\begin{fullpage}
		\caption[Sensitivity analysis using less informative priors for a stratified SEIR model for Ebola in West Africa.]{Sensitivity analysis for a country--stratified SEIR model fit to the West Africa Ebola outbreak using less informative priors for the effective reproductive numbers, cross--border transmission, and infectious period duration vis--a--vis the main model. Subscripts, $ G,L,S, $ indicate specific countries, or generic countries $ A,B $ if a prior is shared. Effective reproduction numbers are defined with respect to the effective population size as $ R_{eff} = \beta N_{eff} /\mu $.}
		\label{tab:ebola_priors_diffuse}
		\scriptsize
		\centering
		\begin{tabular}{lllrr}
			\hline
