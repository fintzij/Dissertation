...
\begin{table}[htbp]
	...
	\begin{tabular}{llrr}
		...
		\hline
		$ R_{eff,G}^{(1)} $& Effective reproduction \#, $ t\leq 8/10/2014 $ & 1.2 (1.1, 1.4) & 1.1 (1.0, 1.3) \\ 
		$ R_{eff,G}^{(2)} $& Effective reproduction \#, $ t> 8/10/2014 $ & 1.4 (1.2, 1.8) & 1.2 (1.1, 1.4) \\ 
		$ 7/\omega_G $& Mean latent period, days & 8.4 (4.0, 17.2) & 7.5 (3.9, 13.6) \\ 
		$ 7/\mu_G $& Mean infectious period, days & 9.0 (5.9, 13.4) & 8.4 (5.9, 11.8) \\ 
		$ 1000\alpha_{G} $& \makecell[l]{Effective \# of baseline infecteds $ \times $ 1,000} & 0.2 (0.0, 0.6) & \rule[0.5ex]{0.75in}{0.5pt}\\
		\makecell[l]{$ 1000\alpha_{LG} $\\ $ 1000\alpha_{SG} $} & \makecell[l]{Effective \# of infecteds in Guinea per \\ \hspace{0.05in} 1,000 infected in Liberia/Sierra Leone} & \rule[0.5ex]{0.75in}{0.5pt} & \makecell[r]{3.9 (0.5, 14.2) \\ 2.6 (0.1, 13.5)} \\
		\hline
		$ R_{eff,L} $& Effective reproduction \#& 2.2 (1.7, 3.3) & 2.1 (1.6, 3.3) \\ 
		$ 7/\omega_L $& Mean latent period, days& 10.5 (4.8, 19.6) & 9.0 (4.1, 19.9) \\ 
		$ 7/\mu_L $& Mean infectious period, days& 9.7 (6.6, 14.1) & 9.0 (6.0, 13.2) \\ 
		$ 1000\alpha_L $& Effective \# of baseline infecteds $ \times $ 1,000 & 0.0 (0, 0.1) &\rule[0.5ex]{0.75in}{0.5pt} \\ 
		\makecell[l]{$ 1000\alpha_{GL} $\\ $ 1000\alpha_{SL} $} & \makecell[l]{Effective \# of infecteds in Liberia per \\ \hspace{0.05in} 1,000 infected in Guinea/Sierra Leone} & \rule[0.5ex]{0.75in}{0.5pt} & \makecell[r]{3.0 (0.1, 15.5) \\ 3.0 (0.1, 16.7)} \\
		\hline
		$ R_{eff,S} $& Effective reproduction \#& 1.3 (1.2, 1.5) & 1.3 (1.1, 1.4) \\ 
		$ 7/\omega_S $& Mean latent period, days& 4.5 (2.6, 7.4) & 4.1 (2.4, 6.6) \\ 
		$ 7/\mu_S $& Mean infectious period, days & 6.2 (4.5, 8.5) & 6.1 (4.4, 8.2) \\ 
		$ 1000\alpha_S $& Effective \# of infecteds per 1,000 & 0.0 (0.0, 0.1) &  \rule[0.5ex]{0.75in}{0.5pt} \\ 
		\makecell[l]{$ 1000\alpha_{GS} $\\ $ 1000\alpha_{LS} $} & \makecell[l]{Effective \# of infecteds in Sierra Leone\\ \hspace{0.05in} per 1,000 infected in Guinea/Liberia} & \rule[0.5ex]{0.75in}{0.5pt} & \makecell[r]{2.6 (0.1, 13.4) \\ 1.4 (0.1, 7.2)} \\
		\hline
	\end{tabular}
\end{table}
