...
There are several reasons to believe \textit{a priori} that the true incidence is significantly under--counted in the dataset, and that reporting rates exhibit substantial variation from country--to--country. First, suspected cases accounted for sizable fractions of the total case counts, but were not available as part of the dataset (see Table \ref{tab:ebola_descriptives}). 
