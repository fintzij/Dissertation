...
\vmcomment{I would say explicitly that the main challenge is that transition probabilities are intractable. Otherwise, it is not clear why you need to integrate to get the complete data likelhood.}
