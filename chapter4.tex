...
Not complete. Waiting on simulation to confirm that the full posterior predictive distribution for the joint model fit via the LNA does not merely need a longer burnin.
