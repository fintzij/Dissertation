...
\vmcomment{Something is wrong with the above sentence; I don't know how to fix it.}
...
\vmcomment{I am not sure I like motivating LNA by the marginal posterior of $\theta$. Why not to say that even if we augment $\theta$ with $N$, we don't get a tractable complete data likelihood?}
