...
It is generally straightforward to specify a valid Markov chain, at least if one is careful in the math and implementation. It is, however, often challenging to design an MCMC scheme that explores the posterior efficiently. We now present a number of MCMC that will be used throughout this dissertation. 
