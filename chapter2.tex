...
- Computational challenges of fitting compartmental models
...
\subsection{Exact Methods for Fitting SEMs}
...
- LNA derivation, refer somewhere else for solution

- use of the LNA in recent literature
