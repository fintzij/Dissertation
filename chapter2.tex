...
\begin{algorithm}[htbp]
	...
	\begin{algorithmic}[1]
		...
		\For{$ k\in1,\dots,p $}
			\State Update: $ \btheta_{J_k}|\btheta_{-J_k},\by\sim\pi(\btheta_{J_k}|\btheta_{-J_k},\by) $
		\EndFor
		\EndProcedure
	\end{algorithmic}
\end{algorithm}
