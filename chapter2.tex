...
\begin{algorithm}[htbp]
	...
	\end{algorithmic}
\end{algorithm}
\vmcomment{You have two $S$s floating around here, one is in 2-D, the other is in 1-D, if $\theta$ is a scalar.}
...
\vmcomment{Jump to approximate $ S^\prime $ here is too sudden and not explained. Maybe you should define bracket and how to use here too, because when you mention it later, it is not clear at all.}
